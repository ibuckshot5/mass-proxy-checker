...
def main():
    ...
    parser.add_argument('-v', '--verbose', default=False,help=('Verbose logging'))
    ...
    with open(args.proxy_file, 'r+') as f:
        with open(args.banned_file, 'w+') as banned:
            with open(args.good_file, 'w+') as good:
                with open(args.error_file, 'w+') as error:
                    proxies = f.readlines()
                    for p in proxies:
    ...
    print('Done checking proxies. You can find them at {} for good ones, and {} for banned ones.'.format(args.good_file, args.banned_file))
